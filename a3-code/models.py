...
#     hidden_size = 10
#     x = torch.autograd.Variable(torch.randn(16, 20))
#     hx = torch.autograd.Variable(torch.randn(16, 10))
#     rnn = MyGRUCell(input_size=hidden_size*2, hidden_size=hidden_size)
#     rnn.forward(x, hx)

#     hidden = torch.autograd.Variable(torch.randn(16, 10))
#     annotations = torch.autograd.Variable(torch.randn(16, 3, 10))
#     rnn = AttentionDecoder(16, 10)
#     rnn.forward(x, hx, annotations)